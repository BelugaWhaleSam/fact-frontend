    ...
    useEffect(() => {
        ...
        axios
            ...
            .catch(function (error) {
                Notiflix.Report.failure('Error', 'The Fact Checker backend is not up and running. To run it: `pnpm backend` and wait for the message `server started on port 3000`', 'Ok');
            })
